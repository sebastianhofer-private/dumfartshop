<?php
namespace WhoShop\WhoShop\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class WhoShop\WhoShop\Controller\ProductController.
 *
...
class ProductControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \WhoShop\WhoShop\Controller\ProductController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('WhoShop\\WhoShop\\Controller\\ProductController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView() {
		...
		$productRepository = $this->getMock('', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenProductToView() {
		$product = new \WhoShop\WhoShop\Domain\Model\Product();
